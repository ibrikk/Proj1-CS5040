...
public class Database {
	...
	// This is an Iterator object over the SkipList to loop through it from outside
	// the class.
	 ...
	 * better not to implement an intersections method in the SkipList class as the
	 * SkipList needs to be agnostic about the fact that it is storing Rectangles.
	 */
